...
private _configContainers = getArray (missionConfigFile >> "ArmaLife_PhoneWarning" >> "controls");
...
uiNamespace setVariable ["ArmaLife_Phone_Warning_Answer",nil];
...
_btnOk ctrlseteventhandler ["buttonclick","uinamespace setvariable ['ArmaLife_Phone_Warning_Answer',true]; true"];
_btnCancel ctrlseteventhandler ["buttonclick","uinamespace setvariable ['ArmaLife_Phone_Warning_Answer',false]; true"];
_display displayaddeventhandler ["unload","uinamespace setvariable ['ArmaLife_Phone_Warning_Answer',false];"];
private _ehKeyDown = _display displayaddeventhandler ["keydown","if ((_this select 1) == 1) then {uinamespace setvariable ['ArmaLife_Phone_Warning_Answer',false]; true} else {false}"];

waitUntil {!isNil {uinamespace getvariable ["ArmaLife_Phone_Warning_Answer",nil]}};
...
_status = uinamespace getvariable "ArmaLife_Phone_Warning_Answer";
