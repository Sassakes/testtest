...
if (!(_vault getVariable ["bankOpen",false])) exitWith {[localize "STR_Cop_VaultLocked",true,"slow"] call ALSG_fnc_notificationSystem;};

life_action_inUse = true;
	
//Setup the progress bar
_title = "Repairing Vault";
_icon = "\ArmalifeCore\images\displays\displayInteractionMenu\organizationAccount.paa";
...
switch (vehicleVarName _vault) do { 
    case "FedVault" : {[true,"relicFed",1] call ALSG_fnc_handleInv;}; 
    default {}; 
};

["FixSafe"] call mav_ttm_fnc_addExp;
[localize "STR_Cop_VaultRepaired",true,"slow"] call ALSG_fnc_notificationSystem;