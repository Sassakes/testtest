...
class ALSG_RscPictureKeepAspect: ALSG_RscPicture {
	style = "0x30 + 0x800";
};

class ALSG_RscProgress {
	type 				= 8;
	style 				= 0;
	x 					= 0.344;
	y 					= 0.619;
...
class ALSG_RscButtonMenu: ALSG_RscShortcutButton {
	idc						= -1;
	type					= 16;
	style					= "0x02 + 0xC0";
	default					= 0;
...
class ALSG_RscCombo {
	...
	class ComboScrollBar: ALSG_ScrollBar {
		color[] = {1,1,1,1};
	};
};

class ALSG_RscListBox {
	x 								= 0;
	y 								= 0;
	w 								= 0.30000001;
	h 								= 0.30000001;
	...
	class ListScrollBar: ALSG_ScrollBar {
		color[]			  = {1,1,1,1};
		autoScrollEnabled = 1;
	};
};

class ALSG_RscStructuredText {
	x 			= 0;
	y		 	= 0;
	h 			= 0.035;
	w 			= 0.1;
...
class ALSG_RscControlsGroup {
	...
	shadow 	= 0;
	style 	= 16;
	class ALSG_VScrollbar: ALSG_ScrollBar {
		width 			  = 0.021;
		autoScrollEnabled = 1;
	};
	class ALSG_HScrollbar: ALSG_ScrollBar {
		height = 0.028;
	};
	class Controls {};
};

class ALSG_RscControlsGroupNoScrollbars: ALSG_RscControlsGroup {
	class VScrollbar: ALSG_VScrollbar {
		width = 0;
	};
	class HScrollbar: ALSG_HScrollbar {
		height = 0;
	};
};

class ALSG_RscControlsGroupNoHScrollbars: ALSG_RscControlsGroup {
	class HScrollbar: ALSG_HScrollbar {
		height = 0;
	};
};

class ALSG_RscControlsGroupNoVScrollbars: ALSG_RscControlsGroup {
	class VScrollbar: ALSG_VScrollbar {
		width = 0;
	};
};
...
class ALSG_RscTree {
	...
	colorPictureRightDisabled[] = {1, 1, 1, 0.25};
	class ScrollBar: ALSG_ScrollBar {};
};

class ALSG_RscTiles: ALSG_RscControlsGroupNoScrollbars {
	idc                 = 115099;
	x                   = "safezoneX";
	y                   = "safezoneY";
	w                   = "safezoneW";
	...
	onLoad              = "[ctrlParent (_this select 0), 'ALSG_displayPause'] call (uiNamespace getVariable 'BIS_fnc_guiEffectTiles')";
	class Controls {
		class TileFrame: ALSG_RscFrame {
			idc             = 114999;
			x               = 0;
			y               = 0;
			w               = "safezoneW";
...
class ALSG_RscBackground: ALSG_RscText {
	idc                = -1;
...
class ALSG_RscDefaultButton: ALSG_RscDefault {
...
class ALSG_RscButton: ALSG_RscDefaultButton {
	type 						= 1;
	style 						= "0x02 + 0xC0";
	colorBackground[] 			= {0, 0, 0, 1};
...
class ALSG_RscButtonPictureKeepAspect: ALSG_RscButton {
	style 						= "0x02 + 0x30 + 0x800";
};
class ALSG_RscButtonToolbar: ALSG_RscButtonPictureKeepAspect {
	colorBackground[] 			= {0, 0, 0, 0};
	colorBackgroundDisabled[] 	= {0, 0, 0, 0};
};

class ALSG_ctrlDefault {
    access = 0;
    idc = -1;
    style = 0;
    default = 0;
...
class ALSG_ctrlDefaultText: ALSG_ctrlDefault {
    sizeEx = "4.32 * (1 / (getResolution select 3)) * pixelGrid * 0.5";
    font = "RobotoCondensedLight";
    shadow = 1;
};

class ALSG_ctrlToolbox: ALSG_ctrlDefaultText {
	type                    = 6;
	style                   = 2;
...
class ALSG_ctrlToolboxPicture: ALSG_ctrlToolbox {
	style                   = "0x02 + 0x30";
};
class ALSG_ctrlToolboxPictureKeepAspect: ALSG_ctrlToolbox {
	style                   = "0x02 + 0x30 + 0x800";
};

class ALSG_ctrlDefaultButton0: ALSG_ctrlDefaultText {
    soundClick[] = {
        "\A3\ui_f\data\sound\RscButton\soundClick",
        0.09,
        1
...
class ALSG_ctrlDefaultButton: ALSG_ctrlDefaultButton0 {
    type						= CT_BUTTON;
    style 						= ST_CENTER;
...
class ALSG_ctrlFloatButton: ALSG_ctrlDefaultButton0 {
    type						= CT_BUTTON;
    style 						= ST_CENTER;
    sizeEx 						= "0.018 * safezoneH";
    colorBackground[] 			= {0, 0, 0, 1};
...
class ALSG_ctrlContentAreaButton: ALSG_ctrlDefaultButton {
    type						= CT_BUTTON;
    style 						= ST_CENTER;
    sizeEx 						= "0.018 * safezoneH";
    colorBackground[] 			= {0, 0, 0, 1};
...
class ALSG_ctrlContentAreaTexturedButton: ALSG_RscButtonMenu {
    animTextureDefault 			= "\ArmalifeCore\images\displays\DISPLAYMenu\buttonTextureNormal.paa";
    animTextureDisabled 		= "\ArmalifeCore\images\displays\DISPLAYMenu\buttonTextureNormal.paa";
    animTexturePressed 			= "\ArmalifeCore\images\displays\DISPLAYMenu\buttonTextureNormal.paa";
    animTextureNormal 			= "\ArmalifeCore\images\displays\DISPLAYMenu\buttonTextureNormal.paa";
    textureNoShortcut 			= "\ArmalifeCore\images\displays\DISPLAYMenu\buttonTextureNormal.paa";
    animTextureFocused 			= "\ArmalifeCore\images\displays\DISPLAYMenu\buttonTextureFocus.paa";
    animTextureOver 			= "\ArmalifeCore\images\displays\DISPLAYMenu\buttonTextureFocus.paa";
    color2[] 					= {1, 1, 1, 0.5};
    color[] 					= {1, 1, 1, 1};
    colorBackground2[] 			= {1, 1, 1, 1};
...
class ALSG_ctrlButton: ALSG_ctrlDefaultButton {
    type = 1;
    style = "0x02 + 0xC0";
    colorBackground[] = {0, 0, 0, 1};
    colorBackgroundDisabled[] = {0, 0, 0, 0.5};
...
class ALSG_ctrlButtonPictureKeepAspect: ALSG_ctrlButton {
    style = ST_CENTER + ST_MULTI + ST_TITLE_BAR + ST_KEEP_ASPECT_RATIO;
};

class ALSG_ctrlButtonToolbar: ALSG_ctrlButtonPictureKeepAspect {
    colorBackground[]           = {0, 0, 0, 0};
    colorBackgroundDisabled[]   = {0, 0, 0, 0};
    shadow                      = 0;
    colorShadow[]               = {0, 0, 0, 0};
...
class ALSG_ctrlButtonCancel: ALSG_ctrlButton {
    h                  = "0.022 * safezoneH";
...
class ALSG_ctrlButtonSearch: ALSG_ctrlButton {
    style       = "0x02 + 0x30 + 0x800";
...
class ALSG_ctrlButtonExpandAll: ALSG_ctrlButtonToolbar {
    style       = "0x02 + 0x30 + 0x800";
...
class ALSG_ctrlButtonCollapseAll: ALSG_ctrlButtonToolbar {
    style       = "0x02 + 0x30 + 0x800";
...
class ALSG_ctrlButtonClose: ALSG_ctrlButtonToolbar {
    idc            = -1;
    style          = "0x02 + 0x30 + 0x800";
...
class ALSG_ctrlShortcutButton: ALSG_ctrlDefaultButton {
    type = 16;
    style = ST_UPPERCASE;
    colorBackground[] = {0,0,0,1};
...
class ALSG_ctrlCheckbox: ALSG_ctrlDefault {
	type = 77;
	checked = 1;
	color[] = {1,1,1,0.7};
	colorFocused[] = {1,1,1,1};
...
class ALSG_ctrlCheckboxSquare: ALSG_ctrlCheckbox {
	w                  = "5 * (pixelW * pixelGrid * 0.50)";
	h                  = "5 * (pixelH * pixelGrid * 0.50)";
};

class ALSG_ctrlControlsGroup: ALSG_ctrlDefault {
    type = 15;
    style = 16;
    x = 0;
    y = 0;
...
class ALSG_ctrlControlsGroupNoScrollbars: ALSG_ctrlControlsGroup {
...
class ALSG_ctrlStatic: ALSG_ctrlDefaultText {
    idc                     = -1;
    type                    = CT_STATIC;
    colorBackground[]       = {0, 0, 0, 0};
    text                    = "";
...
class ALSG_ctrlStaticPicture: ALSG_ctrlStatic {
    style = ST_LEFT + ST_MULTI + ST_TITLE_BAR;
};

class ALSG_ctrlStaticPictureKeepAspect: ALSG_ctrlStaticPicture {
    style = "0x30 + 0x800";
};

class ALSG_ctrlStaticBackground: ALSG_ctrlStatic {
    colorBackground[] = {0.2, 0.2, 0.2, 1};
};

class ALSG_ctrlStaticFooter: ALSG_ctrlStatic {
    colorBackground[] = {0.15, 0.15, 0.15, 1};
    h                 = "(5 + 2) * (pixelH * pixelGrid * 0.50)";
};

class ALSG_ctrlStaticContent: ALSG_ctrlStatic {
    colorBackground[] = {0, 0, 0, 0.5};
};

class ALSG_ctrlStaticTitle: ALSG_ctrlStatic {
    colorText[]       = {1, 1, 1, 1};
    colorBackground[] = {
...
class ALSG_ctrlStaticTitleMoving: ALSG_ctrlStaticTitle {
    moving = 1;
};

class ALSG_ctrlStaticHeader: ALSG_ctrlStatic {
    colorText[]       = {1, 1, 1, 1};
    colorBackground[] = {
        "(profilenamespace getvariable ['GUI_BCG_RGB_R',0.77])",
        "(profilenamespace getvariable ['GUI_BCG_RGB_G',0.51])",
...
class ALSG_ctrlStaticHeaderMoving: ALSG_ctrlStaticHeader {
    moving            = 1;
};

class ALSG_ctrlStaticPictureTile: ALSG_ctrlStatic {
    style = 144;
};

class ALSG_ctrlStaticBackgroundDisableTiles: ALSG_ctrlStaticPictureTile {
    x = -4;
    y = -2;
    w = 8;
    h = 4;
...
class ALSG_ctrlStructuredText: ALSG_ctrlDefaultText {
    type               = 13;
    style 			   = 0;
    colorBackground[]  = {0, 0, 0, 0};
    colorText[]             = {1, 1, 1, 1};
...
class ALSG_ctrlEdit: ALSG_ctrlDefaultText {
	type                   = CT_EDIT;
...
class ALSG_ctrlEditMulti: ALSG_ctrlEdit {
	style = ST_MULTI;
};

class ALSG_ctrlEditMultiCode: ALSG_ctrlEdit {
	style 		 = ST_MULTI + ST_LEFT;
	autocomplete = "scripting";
	font 		 = "EtelkaMonospacePro";
};

class ALSG_ctrlEditNoRect: ALSG_ctrlEdit {
	style = ST_LEFT + ST_NO_RECT;
};

class ALSG_ctrlListbox: ALSG_ctrlDefaultText {
	type = 5;
	style = "0x00 + 0x10";
	colorBackground[] = {0,0,0,0.5};
...
class ALSG_ctrlXListbox: ALSG_ctrlDefaultText {
	type 					= 42;
...
class ALSG_ctrlListNBox: ALSG_ctrlDefaultText {
	type = 102;
	style = "0x00 + 0x10";
	colorSelectBackground[] = {"(profilenamespace getvariable ['GUI_BCG_RGB_R',0.77])","(profilenamespace getvariable ['GUI_BCG_RGB_G',0.51])","(profilenamespace getvariable ['GUI_BCG_RGB_B',0.08])",1};
	colorSelectBackground2[] = {"(profilenamespace getvariable ['GUI_BCG_RGB_R',0.77])","(profilenamespace getvariable ['GUI_BCG_RGB_G',0.51])","(profilenamespace getvariable ['GUI_BCG_RGB_B',0.08])",1};
...
class ALSG_ctrlCombo: ALSG_ctrlDefaultText {
	type = 4;
...
class ALSG_ctrlProgress: ALSG_ctrlDefault {
	type           = CT_PROGRESS;
...
class ALSG_ctrlPrompt: ALSG_ctrlControlsGroupNoScrollbars {
    idd        = -1;
    x          = "safezoneX";
    y          = "safezoneY";
    w          = "safezoneW";
    ...
    class controls {
        ...
        class BUTTON_NO: ALSG_ctrlFloatButton {
            idc                = 1;
            text		       = "";
        ...
        class BUTTON_YES: ALSG_ctrlFloatButton {
            idc                = 2;
            text		       = "";
            x                  = "0.592 * safezoneW";
            y                  = "0.621 * safezoneH";
        ...
        class CONTENT_TITLE: ALSG_ctrlStatic {
            idc                = 3;
            text               = "";
        ...
        class CONTENT_TEXT: ALSG_ctrlStatic {
            idc                = 4;
            text               = "";
...
class ALSG_ctrlPromptSmall: ALSG_ctrlControlsGroupNoScrollbars {
    idd        = -1;
    x          = "safezoneX";
    y          = "safezoneY";
    w          = "safezoneW";
    h          = "safezoneH";
    class controls {
        class HEADER: ALSG_ctrlStaticTitle {
            idc 				= 3;
        ...
        class FOOTER: ALSG_ctrlStaticFooter {
            x 					= "0.396354 * safezoneW";
        ...
        class BUTTON_CANCEL: ALSG_ctrlDefaultButton {
            idc					= 1;
            text				= "";
...
class ALSG_ctrlSliderV: ALSG_ctrlDefault {
	type = 3;
	style = 0;
	color[] = {0,0,0,1};
	colorDisabled[] = {1,1,1,0.25};
...
class ALSG_ctrlSliderH: ALSG_ctrlSliderV {
	style = 1024;
};

class ALSG_ctrlXSliderV: ALSG_ctrlDefault {
	type = 43;
	style = 0;
	color[] = {1,1,1,0.6};
	colorActive[] = {1,1,1,1};
...
class ALSG_ctrlXSliderH: ALSG_ctrlXSliderV {
	style = 1024;
};

class ALSG_ctrlTree: ALSG_ctrlDefaultText {
	type = 12;
	colorBorder[] = {0,0,0,0};
	colorLines[] = {0,0,0,0};
	colorBackground[] = {0,0,0,0};
...
class ALSG_ctrlMap: ALSG_ctrlDefault {
	type = 101;
	style = 48;
	x = "safezoneXAbs";
	y = "safezoneY";
...
class ALSG_ctrlMapEmpty: ALSG_ctrlMap {
...
class ALSG_ctrlMapMain: ALSG_ctrlMap {};

class ALSG_ctrlButtonMapSort: ALSG_ctrlButton {
    idc                = -1;
...
class ALSG_ctrlMapSort: ALSG_ctrlControlsGroupNoScrollbars {
    idc        = -1;
	x          = "safezoneX";
	y          = "safezoneY";
	w          = "safezoneW";
    ...
    class controls {
        ...
        class SEARCHBUTTON_BACKGROUND: ALSG_ctrlStatic {
            idc                = 4;
        ...
        class BUTTON_SEARCHREFRESH: ALSG_ctrlButtonPictureKeepAspect {
            idc                = 5;
        	text               = "\a3\3DEN\Data\Displays\Display3DEN\search_start_ca.paa";
        ...
        class BUTTON_FOCUSLOCATION: ALSG_ctrlButton {
            idc                = 8;
        ...
        class BUTTON_FOCUSONPLAYER: ALSG_ctrlButton {
            idc                = 9;
