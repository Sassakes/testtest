...
for "_i" from 0 to 1 step 0 do {
    ...
    private _abortButton = CONTROL(49,104);
    _abortButton buttonSetAction "[] call ALSG_fnc_updateRequest; profileNamespace setVariable ['AL_Loadout',getUnitLoadout player]; [player] remoteExec [""TON_fnc_cleanupRequest"",2];";
