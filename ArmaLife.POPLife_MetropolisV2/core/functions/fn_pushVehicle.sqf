...
if( locked _veh > 1 ) exitWith {["You cannot push locked vehicles",true,"slow"] call ALSG_fnc_notificationSystem;};
if((_veh isKindOf "Car") OR (_veh isKindOf "Ship") OR (_veh isKindOf "Air")) then
{
	...
	_title = _upp;
	_icon = "\ArmalifeCore\images\displays\displayProgress\gather.paa";
	...
	[format["You have pushed your %1",_displayName],false,"slow"] call ALSG_fnc_notificationSystem;
	sleep 1;
