...
[parseText format["<t color='#FF0000'><t size='2'>%1</t></t><br/><t color='#FFD700'><t size='1.5'>" +(localize "STR_Cop_Licenses")+ "</t></t><br/>%2<br/><br/>%3",_civ,_licenses,_arrestInfo],true,"slow"] call ALSG_fnc_notificationSystem;