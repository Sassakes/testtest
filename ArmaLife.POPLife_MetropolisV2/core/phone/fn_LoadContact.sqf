...
private _handle = ["ArmaLife_ContactView"] spawn ALSG_fnc_changeMenu;
waitUntil {ArmaLife_Phone_CurrentlyOpen == "ArmaLife_ContactView"};
...
private _format = format ["[%1] spawn ALSG_fnc_EditContact",_index];
private _SendMessageformat = format ["['%1'] spawn ALSG_fnc_LoadMessages",_phone];
private _deleteContactFormat = format ["[%1] call ALSG_fnc_DeleteContact", _index];
