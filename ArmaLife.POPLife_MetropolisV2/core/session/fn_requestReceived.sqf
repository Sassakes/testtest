...
if (isNil "_this") exitWith {[] call ALSG_fnc_insertPlayerInfo;};
if (_this isEqualType "") exitWith {[] call ALSG_fnc_insertPlayerInfo;};
if (count _this isEqualTo 0) exitWith {[] call ALSG_fnc_insertPlayerInfo;};
if ((_this select 0) isEqualTo "Error") exitWith {[] call ALSG_fnc_insertPlayerInfo;};
if (!(getPlayerUID player isEqualTo (_this select 0))) exitWith {[] call ALSG_fnc_dataQuery;};
...
switch (playerSide) do {
    ...
    case civilian: {
        ...
        if !(count life_gangData isEqualTo 0) then {
            [] spawn ALSG_fnc_initGang;
        };
        [] spawn ALSG_fnc_initHouses;
    };
