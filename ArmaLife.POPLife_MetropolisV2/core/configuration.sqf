...
ArmaLife_BannedWords = getArray(missionConfigFile >> "ArmaLife_Core_Settings" >> "BannedWords");
...
_vipcolor = profileNamespace getVariable ["ArmaLife_NametagColor",[1,1,1,1]];
player setVariable ["ArmaLife_NametagColor",_vipcolor,true];
