...
if !([false,_itemData, (parseNumber _amountStr)] call ALSG_fnc_handleInv) exitWith {};//does not have the amount to give.
...
[_itemData, (parseNumber _amountStr), player] remoteExec ["ALSG_fnc_receiveItem", _unit]; 
