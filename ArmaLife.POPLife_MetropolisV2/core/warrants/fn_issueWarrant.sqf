...
_ctrlButtonAddWarrant ctrlAddEventHandler ["ButtonClick", {
    ...
    private _player = [_ctrlSelPlayerUID] call ArmaLife_Lib_GetPlayerByUID;
    if (isNull _player) exitWith {};

    [_player, _classname] call ALSG_fnc_addWarrants;
...
_ctrlListCrimes ctrlAddEventHandler ["LBSelChanged", {
    ...
    _priceformatted = [(getNumber (_class >> "ticketValue"))] call ALSG_fnc_numberText;
