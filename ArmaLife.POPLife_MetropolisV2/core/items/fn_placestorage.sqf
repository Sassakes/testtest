...
detach _container;
[_container,true] remoteExecCall ["ALSG_fnc_simDisable",RANY];
...
if ((typeOf _container) == "B_supplyCrate_F") then {
    [false,"storagebig",1] call ALSG_fnc_handleInv;
} else {
    [false,"storagesmall",1] call ALSG_fnc_handleInv;
};

[_container, _isFloating] call ALSG_fnc_placeContainer;
