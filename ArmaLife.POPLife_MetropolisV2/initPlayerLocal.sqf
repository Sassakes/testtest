...
[] spawn {
    ...
    waitUntil {time > 0};
    if (missionNamespace getVariable ["CHBN_running",false]) exitWith {["CHBN script is running, addon disabled",true,"slow"] call ALSG_fnc_notificationSystem;};
    CHBN_running = true;
