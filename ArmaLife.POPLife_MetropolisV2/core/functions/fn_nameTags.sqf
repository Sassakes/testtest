...
_tags = [];
_saved = profileNamespace getVariable ["ArmaLife_NameTags",[]];
{
    ...
    _color = _player getVariable ["ArmaLife_NametagColor",[1,1,1,1]]; 
    ...
    if (_cansee) then
    {
        ...
        _espText = (_player getVariable ["ArmaLife_AdminESP",'']);
