...
if (!(nearestObject [player, "House"] in life_vehicles)) exitWith {[localize "STR_ISTR_Box_NotinHouse",true,"slow"] call ALSG_fnc_notificationSystem;};
...
[_object] remoteExecCall ["ALSG_fnc_simDisable",RANY];
