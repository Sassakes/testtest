...
if (getPlayerUID player isEqualTo (group player getVariable "gang_owner")) exitWith {[localize "STR_GNOTF_LeaderLeave",true,"slow"] call ALSG_fnc_notificationSystem;};
...
[format["%1 has left your gang!",name player],false,"slow"] remoteExec ["ALSG_fnc_notificationSystem",_group];
closeDialog 0;