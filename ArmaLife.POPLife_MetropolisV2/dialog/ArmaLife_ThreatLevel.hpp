class ArmaLife_ThreatLevel {
	idd = 15212;
	name = "ArmaLife_ThreatLevel";
	class controlsBackground
	{
		class ArmaLife_TopBar: Life_RscText
		{
			idc = 1201;
		...
		class ArmaLife_ThreatLevelTopText: Life_RscText
		{
			idc = 1000;
	...
	class controls
    {
    	class ArmaLife_ChooseThreatLevelText: Life_RscCombo
		{
			idc = 2100;
		...
		class ArmaLife_SetThreatLevel: Life_RscButtonMenu
		{
			idc = 2400;
