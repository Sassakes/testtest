...
if (count _sellers isEqualTo 0) exitWith {[localize "STR_Cop_DealerQuestion",true,"slow"] call ALSG_fnc_notificationSystem;}; //No data.
...
[parseText format[(localize "STR_Cop_DealerMSG")+ "<br/><br/>%1",_names],true,"slow"] call ALSG_fnc_notificationSystem;
