...
if ((lbCurSel 2621) isEqualTo -1) exitWith {[localize "STR_GNOTF_SelectKick",true,"slow"] call ALSG_fnc_notificationSystem;};
_unit = call compile format ["%1",CONTROL_DATA(2621)];

if (isNull _unit) exitWith {};	
if (_unit == player) exitWith {[localize "STR_GNOTF_KickSelf",true,"slow"] call ALSG_fnc_notificationSystem;};
