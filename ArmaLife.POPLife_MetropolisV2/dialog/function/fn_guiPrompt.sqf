...
ArmaLife_guiPrompt_return = nil;
private _emptyDisplay = _display createDisplay "RscDisplayEmpty";
private _ctrlName = ["ALSG_ctrlPrompt", "ALSG_ctrlPromptSmall"] select _useSmall;
...
_emptyDisplay displaySetEventHandler ["KeyDown","if ((_this select 1) isEqualTo 1) then {ArmaLife_guiPrompt_return = false; life_action_inUse = false;}"];
...
_ctrlButtonCancel ctrlAddEventHandler ["ButtonClick", {
    ...
    ArmaLife_guiPrompt_return = false;
...
_ctrlButtonOK ctrlAddEventHandler ["ButtonClick", {
    ...
    ArmaLife_guiPrompt_return = true;
    _display closeDisplay 2
}];
...
waitUntil {!isNil "ArmaLife_guiPrompt_return"};
ArmaLife_guiPrompt_return