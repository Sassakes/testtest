...
private _warrants = [displayNull, false] call ALSG_fnc_requestWarrants;
...
_ctrlButtonSendToJail ctrlAddEventHandler ["ButtonClick", {
    ...
    if (_warrants isEqualTo []) exitWith {
    	["This player does not have any warants out for their arrest.",true,"slow"] call ALSG_fnc_notificationSystem;
    };
